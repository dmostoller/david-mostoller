    ...
    >
      ...
      <ModalContent image>
        ...
        <ModalDescription>
          ...
          <p>I have also had a successful career as a professional musician, which enabled me to travel to over 40 countries to perform. I have developed an ability to connect with people across cultural and linguistic divides. Creating music is in many ways similar to programming, whether it’s taking abstract ideas and bringing them into the real world, or functioning seamlessly with your teammates to create something new. I believe that I can contribute a distinct perspective to a development team, one with a keen understanding of the way people experience things, whether that be music, or software. </p>
          <p>I’m passionate about leveraging my unique experience to create user-friendly solutions that treat users as users, rather than products themselves. I am excited about opportunities that will allow me to collaborate with a dynamic team and make a positive impact on the world, and look forward to the opportunity to join a team creating impactful software applications. </p>
          <p>Let’s connect and explore how we can create something meaningful together!</p>        
        </ModalDescription>
      </ModalContent>
      <ModalActions>
        <Button
